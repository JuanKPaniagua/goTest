...
var file_books_info_proto_rawDesc = []byte{
	...
	0x6f, 0x6b, 0x12, 0x2e, 0x0a, 0x0a, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x42, 0x6f, 0x6f, 0x6b,
...
type BookInfoClient interface {
	...
	DeleteBook(ctx context.Context, in *Book, opts ...grpc.CallOption) (*BookID, error)
...
func (c *bookInfoClient) DeleteBook(ctx context.Context, in *Book, opts ...grpc.CallOption) (*BookID, error) {
	out := new(BookID)
...
type BookInfoServer interface {
	...
	DeleteBook(context.Context, *Book) (*BookID, error)
...
func (*UnimplementedBookInfoServer) DeleteBook(context.Context, *Book) (*BookID, error) {
