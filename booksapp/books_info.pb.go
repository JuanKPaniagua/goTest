...
func (x *Deleted) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *Deleted) GetMensaje() string {
	if x != nil {
		return x.Mensaje
	}
	return ""
...
var file_books_info_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x3b, 0x0a, 0x07, 0x44,
	0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x18,
	0x0a, 0x07, 0x4d, 0x65, 0x6e, 0x73, 0x61, 0x6a, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x4d, 0x65, 0x6e, 0x73, 0x61, 0x6a, 0x65, 0x32, 0xc5, 0x01, 0x0a, 0x08, 0x42, 0x6f, 0x6f,
	...
	0x2f, 0x0a, 0x0a, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x42, 0x6f, 0x6f, 0x6b, 0x12, 0x0e, 0x2e,
	0x62, 0x6f, 0x6f, 0x6b, 0x73, 0x61, 0x70, 0x70, 0x2e, 0x42, 0x6f, 0x6f, 0x6b, 0x1a, 0x11, 0x2e,
	0x62, 0x6f, 0x6f, 0x6b, 0x73, 0x61, 0x70, 0x70, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64,
	0x12, 0x2e, 0x0a, 0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x6f, 0x6f, 0x6b, 0x12, 0x10,
...
var file_books_info_proto_goTypes = []interface{}{
	...
	(*Deleted)(nil), // 2: booksapp.Deleted
}
var file_books_info_proto_depIdxs = []int32{
	...
	0, // 2: booksapp.BookInfo.deleteBook:input_type -> booksapp.Book
	1, // 3: booksapp.BookInfo.updateBook:input_type -> booksapp.BookID
	1, // 4: booksapp.BookInfo.addBook:output_type -> booksapp.BookID
	0, // 5: booksapp.BookInfo.getBook:output_type -> booksapp.Book
	2, // 6: booksapp.BookInfo.deleteBook:output_type -> booksapp.Deleted
...
type BookInfoClient interface {
	...
	DeleteBook(ctx context.Context, in *Book, opts ...grpc.CallOption) (*Deleted, error)
	UpdateBook(ctx context.Context, in *BookID, opts ...grpc.CallOption) (*Book, error)
}
...
func (c *bookInfoClient) DeleteBook(ctx context.Context, in *Book, opts ...grpc.CallOption) (*Deleted, error) {
	out := new(Deleted)
...
func (c *bookInfoClient) UpdateBook(ctx context.Context, in *BookID, opts ...grpc.CallOption) (*Book, error) {
	out := new(Book)
...
type BookInfoServer interface {
	...
	DeleteBook(context.Context, *Book) (*Deleted, error)
	UpdateBook(context.Context, *BookID) (*Book, error)
}
...
func (*UnimplementedBookInfoServer) DeleteBook(context.Context, *Book) (*Deleted, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteBook not implemented")
}
func (*UnimplementedBookInfoServer) UpdateBook(context.Context, *BookID) (*Book, error) {
...
func _BookInfo_DeleteBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookInfoServer).DeleteBook(ctx, req.(*Book))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BookInfo_UpdateBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookInfoServer).UpdateBook(ctx, req.(*BookID))
	}
	return interceptor(ctx, in, info, handler)
}
